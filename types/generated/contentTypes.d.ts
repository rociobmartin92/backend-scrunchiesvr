...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    product: Schema.Attribute.Relation<'oneToOne', 'api::produc.produc'>;
    products: Schema.Attribute.Relation<'oneToMany', 'api::produc.produc'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    color: Schema.Attribute.Enumeration<['dorado', 'rosa', 'blanco']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProducProduc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bestSeller: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    isAvaliable: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::produc.produc'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::produc.produc': ApiProducProduc;
